                    ...
                    !isMobile ? (
                        <div className={styles.blocks}>
                                ...
                                <div className={cn(styles.steps, styles.first)}>
                                    <div className={styles.step}>
                                        ...
                                        <div className={styles.infoblock}>
                                            <h3 className={styles.title}>Первая встреча и <br /> погружение в ваш <br /> мир </h3>
                                    ...
                                    <div className={styles.step}>
                                        ...
                                        <div className={styles.infoblock}>
                                            <h3 className={styles.title}>Подготовка <br /> комментариев и <br /> анализ <br /> контекста</h3>
                                    ...
                                    <div className={styles.step}>
                                        ...
                                        <div className={styles.infoblock}>
                                            <h3 className={styles.title}>Глубокий анализ<br /> целей сайта</h3>
                            ...
                            <div className={cn(
                                ...
                                <div className={styles.block}>
                                    <img src="/uxBlockBackgrounds/second.png" alt="" />
                                    <div className={cn(styles.steps, styles.second)}>
                                        <div className={styles.step}>
                                            <span className={styles.id}>06</span>
                                            <div className={styles.infoblock}>
                                                <h3 className={styles.title}>Идентификация<br /> болей и "горячих<br /> зон"</h3>
                                        ...
                                        <div className={styles.step}>
                                            ...
                                            <div className={styles.infoblock}>
                                                <h3 className={styles.title}>Генерация идей<br /> для изменений</h3>
